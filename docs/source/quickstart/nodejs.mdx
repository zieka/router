...
If you are looking for a less involved example, have a look at the [🐳 Docker based example](docker) or the no dependencies [🧑‍🚀 Apollo studio based example](studio).
...
### Port 4100 isn't available on my machine 😓
